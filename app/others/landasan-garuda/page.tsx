...
export default function LandasanGarudaPage() {
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="w-full flex items-center justify-center p-4 sm:p-8">
              <img
                src="/images/others/landasan-garuda.png"
                alt="Landasan Garuda"
            ...
            <div className="flex flex-col justify-center text-left">
              {/* Category / Tag */}
              <span className="text-sm font-normal tracking-wider uppercase text-neutral-500 mb-2">
                Artifact Details
              </span>
              ...
              <div className="space-y-4 text-base sm:text-lg text-neutral-800 font-normal leading-relaxed">
                <p>
                  This serves as a base or pedestal for a statue. In Hindu
                  mythology, Garuda is the mount (*vahana*) of the god Vishnu.
                  Garuda is depicted as a winged human figure with a *naga*
                  (serpent) beneath him; he symbolizes courage and the
                  dispelling of darkness and evil.
                </p>
                <p>
                  Material: Andesite stone. Origin: Kadisoka Site, Purwomartani,
                  Kalasan, Sleman. This site is estimated to date from the 8th
